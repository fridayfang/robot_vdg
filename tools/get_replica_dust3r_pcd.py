...
for scene in scenes: 
    ...
    if demo_setting: 
        img_dir_for_dust3r = os.path.join("./dust3r_results/Replica_{}v_thr{}_trimeshsave_minconf1_demosetting/{}".format(n_views, int(dust3r_min_conf_thr), scene))
    else: 
        img_dir_for_dust3r = os.path.join("./dust3r_results/Replica_{}v_thr{}_trimeshsave_minconf1/{}".format(n_views, int(dust3r_min_conf_thr), scene))
